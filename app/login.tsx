...
const styles = StyleSheet.create({
  ...
  form: { marginTop: 28 }, label: { color: "#7B8598", fontSize: 11, lineHeight: 15, fontWeight: "800", letterSpacing: 1.05, marginBottom: 7, marginLeft: 2 }, inputWrap: { height: 54, borderRadius: 16, borderWidth: 1, borderColor: "#DDE2EC", backgroundColor: "#FFFFFF", flexDirection: "row", alignItems: "center" }, prefix: { color: palette.indigo, fontSize: 17, fontWeight: "800", paddingLeft: 16, marginRight: 1 }, input: { flex: 1, height: "100%", color: palette.ink, fontSize: 16, paddingRight: 14 }, eye: { height: 44, width: 44, alignItems: "center", justifyContent: "center", marginRight: 2 },
  error: { flexDirection: "row", gap: 7, alignItems: "center", backgroundColor: "#FFF0F2", borderRadius: 12, padding: 10, marginTop: 14 }, errorText: { flex: 1, color: palette.coral, fontSize: 13, lineHeight: 17, fontWeight: "600" },
